...
import { Camera, Trash2, RotateCw, Check, ImageIcon, Loader2 } from "lucide-react"
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md bg-gradient-to-br from-blue-50 via-white to-indigo-50 border-0 shadow-2xl">
        ...
        <div className={`relative ${getAspectRatioClass()} w-full bg-black rounded-lg overflow-hidden`}>
          {isLoading && (
