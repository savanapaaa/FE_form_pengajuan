            ...
            <div className="flex items-center justify-between">
              ...
              >
                <motion.div
                  ...
                  className="w-8 h-8 sm:w-12 sm:h-12 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl flex items-center justify-center shadow-lg flex-shrink-0"
                >
                  <Crown className="h-4 w-4 sm:h-7 sm:w-7 text-white" />
                </motion.div>
                <div className="min-w-0 flex-1">
                  <h1 className="text-base sm:text-2xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent truncate">
                    {isEditMode ? "Edit Pengajuan" : "Sistem Pelayanan Publik"}
                  </h1>
                  <p className="text-xs text-gray-600 hidden sm:block">
                    Platform digital untuk pengajuan konten komunikasi publik
                  </p>
                </div>
              </motion.div>
                ...
                {isEditMode ? (
                  ...
                  >
                    <Button
                      ...
                      size="sm"
                      onClick={cancelEdit}
                      className="bg-red-50 border-red-200 text-red-700 hover:bg-red-100 hover:border-red-300 shadow-sm"
                    >
                  ...
                  >
                    <Button
                      ...
                      size="sm"
                      onClick={() => router.push("/history")}
                      className="bg-white/70 backdrop-blur-sm border-gray-200 hover:bg-indigo-50 hover:border-indigo-300 shadow-sm transition-all duration-200"
                    >
                    ...
                    <Button
                      ...
                      className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105"
                    >
